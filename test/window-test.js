...
ok('年度模式：Q1 曲线生效 → Clt≈34.2', near(r3f.scenarios[0].Clt, 1000 * 300 / 8760, 0.1), r3f.scenarios[0].Clt);
...
ok('窗口模式：9月 420 曲线生效 → Clt=200×420/2928', near(r4w.scenarios[0].Clt, 200 * 420 / 2928, 0.1), r4w.scenarios[0].Clt);
